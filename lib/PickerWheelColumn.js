...
class PickerWheelColumn extends Component<void, Props, State> {
    ...
    _moveTo(obj, currentIndex, direction) {
        ...
        const maxAdditionalIndexesToTravel = 5;
        const additionalIndexesToTravel = Math.min(
            Math.floor(unitsToTravel / this.itemHeight),
            maxAdditionalIndexesToTravel
        );
