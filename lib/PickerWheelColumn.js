    ...
    _moveTo(obj, currentIndex, direction) {
        ...
        */
        ...
        if (this.estimatedAccelerationRate !== this.accelerationRate) {
            ...
            const totalTargetDistTravelled = estimatedDistTravelled - (estimatedDistTravelled % this.itemHeight);
            //const targetDistTravelled = totalTargetDistTravelled / FIXED_SPIN_ANIMATION_TIME;
            const predictedAccelerationRate = ((totalTargetDistTravelled - ((this.velocity * FIXED_SPIN_ANIMATION_TIME) * numberOfAccelerationEvents)) * 2) / (Math.pow(numberOfAccelerationEvents, 2) * FIXED_SPIN_ANIMATION_TIME);
            console.log({
