    ...
    _moveTo(obj, currentIndex, direction) {
        ...
        */
        ...
        if (this.estimatedAccelerationRate !== this.accelerationRate) {
            ...
            const estimatedDistTravelled = (this.velocity * numberOfAccelerationEvents + (0.5 * this.estimatedAccelerationRate * Math.pow(numberOfAccelerationEvents, 2))) * FIXED_SPIN_ANIMATION_TIME;
