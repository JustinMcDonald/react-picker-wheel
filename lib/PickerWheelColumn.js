    ...
    _moveTo(obj, currentIndex, direction) {
        ...
        */
        ...
        if (this.estimatedAccelerationRate !== this.accelerationRate) {
            ...
            const targetDistTravelled = estimatedDistTravelled - (estimatedDistTravelled % this.itemHeight) + this.itemHeight;
        ...
        let unitsToTravelNow = this.velocity;
        // todo simplify accel prediction and make this more accurate
        if (this.remainderDistTravelled > 0 && direction >= 0 ||
            this.remainderDistTravelled < 0 && direction <= 0) {
