...
const FIXED_SPIN_ANIMATION_TIME = 10;
    ...
    _moveTo(obj, currentIndex, direction) {
        ...
        */
        ...
        this.spinTimeout = setTimeout(() => {
            if (Math.floor(this.state.translateY / this.itemHeight) !== this.currentIndex) {
                this._updateItemsAndMargin(this.currentIndex - Math.floor(this.state.translateY / this.itemHeight));
            }
